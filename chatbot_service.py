...
class ChatbotService:
    def __init__(self):
        ...
        self.onOffice = OnOfficeAPI(os.getenv('ONOFFICE_API_KEY'), os.getenv('ONOFFICE_SECRET_TOKEN'))  # Initialize OnOfficeAPI
    ...
    async def get_response(self, prompt):
        ...
        if price and location:
            ...
            if properties:
                return f"I found {len(properties)} properties in {location} under {price}."
            else:
